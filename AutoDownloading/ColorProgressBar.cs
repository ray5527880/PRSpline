...
namespace AutoDownloading
{
	...
	//		Color bgColor = ControlPaint.Light(_BarColor);
            Color bgColor = this._BackColor;
        ...
        public void Setup(ref ColorProgressBar m_PrgBar,Form frm)
        {
            m_PrgBar.BarColor = System.Drawing.Color.FromArgb(((System.Byte)(20)),
                ((System.Byte)(191)), ((System.Byte)(255)));
            m_PrgBar.BorderColor = System.Drawing.Color.White;
            m_PrgBar.FillStyle = ColorProgressBar.FillStyles.Solid;
            m_PrgBar.Location = new System.Drawing.Point(12, 526);

            m_PrgBar.Name = "PgrBar";
            m_PrgBar.Size = new System.Drawing.Size(1040, 30);
            m_PrgBar.Step = 10;
            m_PrgBar.TabIndex = 0;
            m_PrgBar.Value = 0;

            frm.Controls.Add(m_PrgBar);       
        }
	}
}